...
void Juego::Moverse(Jugador e, const Coordenada &c){
    ...
    if (!MovValido(e, c)) {
        ...
        // std::cout << "Desde: " << _jugadores[e]._pos << " hasta " << c << "\n";
...
void Juego::CasoMov1(Jugador e, const Coordenada& antes, const Coordenada& desp){
    ...
    // // Aumento todos los contadores excepto el actual
    // while (it.HaySiguiente()) {
    //     Nat x = it.Siguiente().latitud;
    //     Nat y = it.Siguiente().longitud;
    //     if (Coordenada(x,y) == PosPokemonCercano(desp)){

    //     } else { 
    //         _pokenodos[x][y]->_contador++;
    //     }
    //     it.Avanzar();
    // }
    ...
    //         std::cout << "Pre borrar siguiente: " << _posPokemons << "\n";
    //         // Borro el pokenodo.
    //         it.EliminarSiguiente();
    //         std::cout << "Post borrar siguiente: " << _posPokemons << "\n";
    //         _pokenodos[x][y] = NULL;
    //         // delete pokeNodo;
    //         continue;
    //     }
    ...
    while (it.HaySiguiente()) {
        ...
        // std::cout << "no entre aun al if: " << it.Siguiente() <<"\n";
        if (it.Siguiente() != pokePos) {
            // std::cout << "entre al if: " << it.Siguiente() <<"\n";
